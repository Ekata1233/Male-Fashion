...
function Shop() {
  ...
  const handleWishlistClick = (item) => {
    ...
    const alreadyInWishlist = existingHeart.find(
  ...
  return (
    <div className="shopDiv pb-4" style={{ paddingTop: "135px" }}>
      <div className="bg-secondary bg-opacity-10  mb-5">
        <img
          src="/about_1.jpg"
          className="s"
        ...
        <Row className="ms-4 text-start">
          <Col md={3} className="">
            ...
            <div className="mt-3 custom-accordion">
              ...
              <Accordion defaultActiveKey="" className="my-2 w-75 ">
                <Accordion.Item eventKey="0">
