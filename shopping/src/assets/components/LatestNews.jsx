...
function LatestNews() {
  ...
  return (
    <div className="latestNewsMainDiv text-start mb-5" >
      <Container className="" style={{marginBottom:"200px"}}>
        <Row>
          <Col lg={4}>
          ...
          <Col lg={4}>
          <Card style={{ width: "22rem" }} className="blogCard">
          <Card.Img variant="top" src="/image_3.jpg" />
          <Card.Body className="cardBody w-75 px-4">
            
            <Card.Text>
              <p><img src="/calendar.png" alt="calender" className="me-2"/>21 February 2023</p>
              <h6 className="fw-bold">What Curling Irons Are The Best Ones</h6>
              <p className="fw-bold read">READ MORE</p>
            </Card.Text>
          ...
          <Card.Body className="cardBody w-75 px-4">
            ...
            <Card.Text>
              <p><img src="/calendar.png" alt="calender" className="me-2"/>28 February 2023</p>
              <h6 className="fw-bold">What Curling Irons Are The Best Ones</h6>
              <p className="fw-bold read">READ MORE</p>
            </Card.Text>
